  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {collections.map((collection, index) => {
            ...
            return (
              <div
                key={collection.id}
                className="group cursor-pointer bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-400 transform hover:-translate-y-1 hover:scale-[1.01]"
                ...
                <div className="relative overflow-hidden aspect-[3/2] sm:aspect-[4/3]">
                  ...
                  <div className="flex items-center justify-between">
                    <button 
                      ...
                      className="flex items-center text-gray-900 font-semibold group-hover:text-gray-700 transition-colors duration-300 text-sm"
                    >
                      Explore Now
